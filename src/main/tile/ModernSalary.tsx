...
export default function ModernSalary() {
  ...
  return (
    <div className="kpi-card-container">
      <DiwaCard varient="primary" loadingTracker={false} className="glass-panel customer-card">
          ...
          <>
            {reportInfo.month !== "" ? (
              <h2 className="panel-title text-color mb-0" style={{ flex: 1 }}>
                ...
                <p className="panel-sub small text-color-50 mt-1">
                ...
                <Accordion flush key={val.name}>
                  <Accordion.Header className="w-100 text-color">
                    <div className="w-100 pe-2 pb-2">
                      <div className="text-start d-inline panel-normal fw-bold text-capitalize text-color">
                  ...
                  <Accordion.Body>
                    <ul className="list-group list-group-flush">
                      <li
                        className="panel-normal list-group-item bg-transparent text-color ps-0"
                        key={val.name + "item1present"}
                      >
                        <div>
                          <FontAwesomeIcon icon={faCalendarDays} />
                          &nbsp;{" "}
                          {`Salary for ${reportInfo.days - val.dayOff.filter((v) => !v.ignored).length} days (incl. ${
                      ...
                      >
                        ...
                        <Row className="mx-0 border-top mt-2">
                          <Col xs="8">
                            <strong>Total</strong>
                          </Col>
                          <Col xs="4" className="text-end">
                      ...
                      {val.dayOff.map((item) => {
                        return (
                          ...
                          >
                            <FontAwesomeIcon icon={faCalendarXmark} className="brand-icon-color" />
                      ...
                      {val.missedEntry.map((item) => {
                        return (
                          ...
                          >
                            <FontAwesomeIcon icon={faPersonWalkingArrowRight} className="brand-icon-color" />
                            <span className={item.ignored ? "text-decoration-line-through" : ""}>
                              {" "}
                      ...
                      {val.lateDays.map((item) => {
                        return (
                          <li
                            ...
                            key={val.name + "item2" + item.day}
                          >
                            <FontAwesomeIcon icon={faArrowRightToBracket} className="brand-icon-color" />
                            <span className={item.ignored ? "text-decoration-line-through" : ""}>
                              {" "}
                      ...
                      {val.earlyExitDays.map((item) => {
                        return (
                          ...
                          >
                            <FontAwesomeIcon icon={faArrowRightFromBracket} className="brand-icon-color" />
                            <span className={item.ignored ? "text-decoration-line-through" : ""}>
                              {" "}
